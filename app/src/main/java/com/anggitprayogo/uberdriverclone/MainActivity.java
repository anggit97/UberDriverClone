...
import com.anggitprayogo.uberdriverclone.Model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showLoginDialog() {
        ...
        dialog.setMessage("use email and password to signin");
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Snackbar.make(rootLayout,"Fail to login",Snackbar.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                auth.createUserWithEmailAndPassword(edtEmail.getText().toString(),edtPassword.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        //use UID key as primary
                        users.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                .setValue(user)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Snackbar.make(rootLayout,"Register succesful!", Snackbar.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Snackbar.make(rootLayout,"Ragiter fail! "+e.getMessage(), Snackbar.LENGTH_SHORT).show();
                                    }
                                });
